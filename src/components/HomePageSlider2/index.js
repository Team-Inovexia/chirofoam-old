                    ...
                    <div className="ml-0 ml-sm-4 pt-0 pt-sm-0 pl-0 pr-sm-5">
                      <Media className="my-3">
                        ...
                        <div className="d-flex h-effect">
                          <Media left="left" middle="middle" className="my-0 pr-4 h4 erbaum-bold" style={{
                              fontSize: '32px'
                            }}>97%</Media>
                          <Media body="body" middle="middle" className="proxima-r pl-sm-3 text-1 align-self-center">Improvement in sleep comfort and quality</Media>
                        </div>
                      </Media>
                      <Media className="py-3">
                        ...
                        <div className="d-flex h-effect">
                          ...
                          <Media body="body" middle="middle" className="proxima-r pl-sm-3 text-1 align-self-center">Increased energy in the morning and throughout the day</Media>
                        </div>
                      </Media>
                      <Media className="py-3">
                        ...
                        <div className="d-flex h-effect">
                          ...
                          <Media body="body" middle="middle" className="proxima-r pl-sm-3 pt-sm-1 text-1 align-self-center">Improved muscle recovery and/or relief in daliy experienced back pain</Media>
                        </div>
                      </Media>
                      <Media className="py-3">
                        ...
                        <div className="d-flex h-effect">
                          ...
                          <Media body="body" middle="middle" className="proxima-r pl-sm-3 pt-sm-2 text-1 align-self-center">Improvement in sleep comfort and quality</Media>
                        </div>
                      </Media>
                    </div>
                ...
                <Row className="pt-sm-5 pt-3">
                  ...
                  <Col sm="6">
                    <Media className="px-2 px-sm-2 px-md-3 px-lg-5 px-xl-5 pb-3 pb-sm-5">
                      ...
                      <Media body="body" middle="middle" className="pl-3 text-white">
              ...
              <Container className="position-relative" style={{
                ...
                <Row className="py-5 my-sm-5 my-0 mx-0">
                  <Media className="px-3 px-sm-5 mb-1 d-block d-sm-flex">
                    ...
                    <Media body="body" middle="middle" className="pl-sm-4 pl-0 pb-0">
                  ...
                  <Media className="px-3 px-sm-5 mb-0 d-block d-sm-flex">
                    ...
                    <Media body="body" middle="middle" className="pl-sm-4 pl-0 pb-3">
