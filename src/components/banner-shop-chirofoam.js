...
const Banner = () => (
	<section>
		<Container>
            ...
            <Link activeClass="active" className="btn-cta color-primary erbaum-bold space-1" to="product" containerId="product" spy={true} hashSpy={true} smooth={true} duration={250}>BUY NOW</Link>
					</p>
				</Col>
				<Col md="5">
