  ...
  return (<> <SEO title
    ...
    <Row>
      ...
      <Col sm="6" className="m-size">
        <img src={mattress_size} alt="Mattress Sizes" style={{
            width: '100%'
          }}/>
      </Col>
    </Row>
...
<section className="globe parallax">
  <Container>
    <Row className="text-center">
      ...
      <ScrollAnimation animateIn="fadeInUp">
        <p className="space-4 proxima-r text-white w-100 m-auto text-center px-0 pb-2 pb-sm-5" style={{
            fontSize: '26px'
          }}>Increased comfort and support while you sleep.</p>
      </ScrollAnimation>
...
</section> <ScrollAnimation animateIn="fadeInUp" > <section className="rating-and-review py-5 py-sm-5">
