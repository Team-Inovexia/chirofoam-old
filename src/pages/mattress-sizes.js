			...
			<Container>
				<Row>
					<Col sm="6" className="text-center">
						<ScrollAnimation animateIn="fadeInUp"><h1 className="display-5 font-weight-bold erbaum-bold text-uppercase pt-5 space-3 color-primary px-0 pb-3 text-center text-sm-left text-lg-center text-xl-center">ONE MATTRESS SIZE DOES NOT FIT ALL.</h1></ScrollAnimation>
			...
			<Container>
				<Row className="m-0">
					<div className="all-mattress text-center mb-2 mb-sm-5 pb-0 pb-sm-5">
						<img src={xl_twin_size} alt="XL Twin Size"/>
						<ScrollAnimation animateIn="fadeInUp"><h4 className="space-1 color-primary erbaum-bold text-uppercase py-2 py-sm-5 mb-0">Single/Twin Mattress</h4></ScrollAnimation>
						<ScrollAnimation animateIn="fadeInUp"><p className="mattress-desc space-3 proxima-r color-primary m-auto text-center px-0 pb-2 pb-sm-5">The Chirofoam™ single/twin mattress is an ideal fit for compact living spaces and relaxing all by yourself.  Perfect for one person or growing kids, the single/twin mattress measures 39 inches wide and 75 inches in length.</p></ScrollAnimation>
						<p className="cta mt-0 pt-sm-0 pt-lg-0 pt-xl-0 mb-sm-2">
					...
					<div className="all-mattress text-center mb-2 mb-sm-5 pb-0 pb-sm-5">
						<img src={queen_size} alt="Queen Size"/>
						<ScrollAnimation animateIn="fadeInUp"><h4 className="space-1 color-primary erbaum-bold text-uppercase py-2 py-sm-5 mb-0">Queen Mattress</h4></ScrollAnimation>
						<ScrollAnimation animateIn="fadeInUp"><p className="mattress-desc space-3 proxima-r color-primary m-auto text-center px-0 pb-2 pb-sm-5">Larger than a double bed and a common choice for most bedrooms, the Chirofoam Queen mattress measures out 60 inches wide and 80 inches in length. The Queen is a spacious mattress, providing more room for couples to rest than the double or individuals who enjoy an ample amount of space to get comfortable on.</p></ScrollAnimation>
						<p className="cta mt-0 pt-sm-0 pt-lg-0 pt-xl-0 mb-sm-2">
					...
					<div className="all-mattress text-center mb-2 mb-sm-5 pb-0 pb-sm-5">
						...
						<ScrollAnimation animateIn="fadeInUp"><h4 className="space-1 color-primary erbaum-bold text-uppercase py-2 py-sm-5 mb-0">King Mattress</h4></ScrollAnimation>
						<ScrollAnimation animateIn="fadeInUp"><p className="mattress-desc space-3 proxima-r color-primary m-auto text-center px-0 pb-2 pb-sm-5">The King mattress by Chirofoam™ is 16 inches wider than the queen mattress, measuring 76 inches wide by 80 inches long.  The main difference between the Queen, King and Cali King mattresses are the size dimensions, the amount of space available in the bedroom and how much preferred space each sleeper needs. A King requires a more spacious bedroom to fit this size mattress.</p></ScrollAnimation>
						<p className="cta mt-0 pt-sm-0 pt-lg-0 pt-xl-0 mb-sm-2">
					...
					<div className="all-mattress text-center mb-2 mb-sm-5 pb-0 pb-sm-5">
						<img src={cali_king} alt="Cali King Size"/>
						<ScrollAnimation animateIn="fadeInUp"><h4 className="space-1 color-primary erbaum-bold text-uppercase py-2 py-sm-5 mb-0">Cali King Mattress</h4></ScrollAnimation>
		...
		<section className="globe parallax">
			<Container>
				<Row className="text-center">
					<ScrollAnimation animateIn="fadeInUp"><h4 className="space-1 text-white erbaum-bold text-uppercase pb-2 pb-sm-5 w-100 mb-0 display-5">Cali King Mattress</h4></ScrollAnimation>
					<ScrollAnimation animateIn="fadeInUp"><p className="space-4 proxima-r text-white w-100 m-auto text-center px-0 pb-2 pb-sm-5" style={{fontSize:'26px'}}>Increased comfort and support while you sleep.</p></ScrollAnimation>
