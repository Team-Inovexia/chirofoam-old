			...
			<Container>
				...
				<Row className="py-3 mb-0 mb-sm-5 charity-inner text-center mx-0">
					<Col sm="6" className="mb-3 mb-sm-5 mt-3 mt-sm-5 text-center px-0 px-sm-2 px-md-2 px-lg-4 px-xl-4">
						...
						<ScrollAnimation animateIn="fadeInUp"><h5 className="erbaum-bold color-primary pb-2 pb-sm-5 text-uppercase text-center">IMPROVED COMFORT AND SLEEP QUALITY</h5></ScrollAnimation>
					...
					<Col sm="6" className="mb-3 mb-sm-5 mt-3 mt-sm-5 text-center px-0 px-sm-2 px-md-2 px-lg-4 px-xl-4">
						...
						<ScrollAnimation animateIn="fadeInUp"><h5 className="erbaum-bold color-primary pb-2 pb-sm-5 text-uppercase text-center">QUALITY MATERIALS AND SKILLED CRAFTSMANSHIP</h5></ScrollAnimation>
					...
					<Col sm="6" className="mb-3 mb-sm-5 mt-3 mt-sm-5 text-center px-0 px-sm-2 px-md-2 px-lg-4 px-xl-4">
						...
						<ScrollAnimation animateIn="fadeInUp"><h5 className="erbaum-bold color-primary pb-2 pb-sm-5 text-uppercase text-center">100 NIGHT IN HOME SLEEP TRIAL</h5></ScrollAnimation>
